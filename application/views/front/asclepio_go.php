            ...
            <div class="row wrap-box-card slider" data-items="4">
                ...
                ?>
                    <div class="col-lg-3 col-md-6 slider__item">
                        ...
                        <div class="box-card">
                            <?= $ribbon ?>
                            <a href="<?= base_url() ?>asclepiogo/<?= $or->slug ?>">
        ...
        <div class="container">
            ...
            <div class="row wrap-box-card">
                ...
                foreach ($open as $o) {
                    ...
                    $expire_time = strtotime($o->tgl_kelas . ' ' . $o->waktu_mulai);
                    $date = $o->public_date;
                    $new_date = date("Y-m-d", strtotime("+2 day", strtotime($date)));
                ...
                ?>
                    <div class="col-md-3 slider__item">
                        <div class="box-card">
                            <?= $ribbon ?>
                            <a href="<?= base_url() ?>asclepiogo/<?= $o->slug ?>">
        ...
        <div class="container">
            ...
            <div class="row wrap-box-card">
                ...
                foreach ($expert as $e) {
                    ...
                    $expire_time = strtotime($e->tgl_kelas . ' ' . $e->waktu_mulai);
                    $date = $e->public_date;
                    $new_date = date("Y-m-d", strtotime("+2 day", strtotime($date)));
                ...
                ?>
                    <div class="col-lg-3 col-md-6 slider__item">
                        <div class="box-card">
                            <?= $ribbon ?>
                            <a href="<?= base_url() ?>asclepiogo/<?= $e->slug ?>">
