...
if (!function_exists('meta_tags')) {
    function meta_tags($enable = array('general' => true, 'og' => true, 'twitter' => true, 'robot' => true), $title_meta = '', $desc = '', $imgurl = '', $keyword = '', $url = '')
    {
        $CI = &get_instance();
        ...
        if ($title_meta == '') {
            $title_meta = $CI->config->item('seo_title');
        }
        if ($desc == '') {
        ...
        if ($enable['general']) {
            ...
            $output .= '<meta name="keyword" content="' . $keyword . '" />';
            $output .= '<meta property="fb:app_id" content="461369001791057" />';
        }
        if ($enable['robot']) {
        ...
        //open graph
        if ($enable['og']) {
            $output .= '<meta property="og:title" content="' . $title_meta . '"/>'
